...
public class UserTest {
    ...
    public void setUserIdTest(){
        User u = new User(1, room, "6406776743","testUser1","Test main.model.user.User");
        int id = 1234;
        u.setUserId(id);
    ...
    public void setUserRoomTest(){
        User u = new User(1, room, "6406776743","testUser1","Test main.model.user.User");
        Room newRoom = new Room(1,"Double",2,1500,false);
        u.setUserRoom(newRoom);
        assertEquals(newRoom,u.room);
    }
